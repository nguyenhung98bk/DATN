...
<div class="navbar navbar-inverse" role="navigation" style="background-color: #213351; margin-top: -20px">
    <div class="navbar-header">
        <a class="navbar-brand" href="#" style="font-size: 18px"><img src="imgs/quochuy.gif" alt="" width="50"
                                                                      height="50"
                                                                      style="margin-top: -10px;margin-right:8px;display: inline;">
            Hệ thống thi trắc nghiệm trường THPT Tạ Quang Bửu
        </a>
        ...
        <div class="sidebar-content">
            ...
            <div class="user-menu dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                   style="background-color: #213351;color: #fff;">
                    <img src="imgs/demo/users/face1.png" alt="">
                    <div class="user-info">
							<span>
                                @if(Auth::check())
            ...
            <ul class="navigation">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{url('admin/teacher')}}"><span
                                    style="padding-right: 80px">Danh sách giáo viên</span>
                                <i class="fas fa-chalkboard-teacher"></i> </a>
                        </li>
                        <li>
                            <a href="{{url('admin/insertteacher')}}"><span
                                    style="padding-right: 120px">Thêm</span><i class="fas fa-plus"></i> </a>
                        </li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{url('admin/student')}}"><span style="padding-right: 80px">Danh sách học sinh</span>
                                <i class="fas fa-user-graduate"></i> </a>
                        </li>
                        <li>
                            <a href="{{url('admin/insertstudent')}}"><span style="padding-right: 120px">Thêm</span><i
                ...
                <li>
                    <a><span>Quản lý lớp thi</span> <i
                            class="fab fa-buromobelexperte"></i></a>
                    <ul>
                        <li>
                            <a href="{{url('admin/lopthi')}}"><span
                                    style="padding-right: 80px">Danh sách lớp thi</span> <i class="fas fa-list"></i> </a>
                        </li>
                        <li><a href="{{url('admin/get_taolopthi')}}"><span
                                    style="padding-right: 50px">Thêm lớp thi</span> <i class="fas fa-plus"></i> </a></li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{url('admin/user/dsuser')}}"><span
                                    style="padding-right: 80px">Danh sách users</span> <i class="fas fa-users"></i> </a>
                        </li>
                        <li><a href="{{url('admin/user/themuser')}}"><span style="padding-right: 50px">Thêm user</span>
                                <i class="fas fa-user-edit"></i> </a></li>
        ...
        <div class="breadcrumb-line">
            ...
            <ul class="breadcrumb-buttons collapse">
                ...
                <li class="language dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="" alt=""> <span>German</span>
                        <b class="caret"></b></a>
                    <ul class="dropdown-menu dropdown-menu-right icons-right">
